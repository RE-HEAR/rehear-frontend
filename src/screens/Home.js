        ...
        <Section1>
          ...
          <ContentWrap>
            <Content1>
              <TextBox>
                <SubContent1>
                  엔젤투자자와 투자유치건에 대해서 이런 갈등 어쩌구 저쩌구
                </SubContent1>
                <SubContent2>
                  <SubText2>
                    이번에 제가 창업을 했는데 생각했던 것보다 힘들고 어려워서
                    다른 분들은 어떻게 이겨냈는지 궁금해요. 저는 특히 세무
                    부분에 대해 무지하여 혼자 다 하려고 하니 힘들었는데 그나마
                    리:히어 어쩌구 저쩌구
                  </SubText2>
                </SubContent2>
                <ImgContent1>
            ...
            <Content1>
              <TextBox>
                ...
                <SubContent2>
                  <SubText2>안녕하세용 두줄이 최대임</SubText2>
                </SubContent2>
                <ImgContent1>
                  <div style={{ display: "flex" }}>
                    <ThumbUpOffAltIcon />
              ...
              <TextBox>
                ...
                <SubContent2>
                  <SubText2>
                    ...
                    대표 김채소입니다. 저희는 현재 와디즈 펀딩 3차까지 성공리에
                    마치며 충성 고객을 모으고 있는데요, 막상 매출액 어쩌고
                    저쩌고
                  </SubText2>
                </SubContent2>
                <ImgContent1>
        ...
        <Section4>
          ...
          <BookContent>
            <Content4>
              ...
              <SubContent3>
                자본이 많아야만 성공한다? 소자본으로 실패 후, 소자본으로 성공한
                대표 8인의 인터뷰
              </SubContent3>
            </Content4>
            <Content4>
